...
This privacy policy governs your use of the software application {{% appname %}} (“Application”) for mobile devices that was created by Developer {{% developer %}}. The Application is Basic description of the app (features, functionality and content) 
